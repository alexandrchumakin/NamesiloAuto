...
namespace NamesiloAuto
{
    ...
    public delegate AutomationElement FindControlElementDelegate(
        AutomationElement parent, string controlName, string controlAutomationId, ControlType type);
    ...
    internal static class UIAutomationHelper
    {
        ...
        public static AutomationElement FindControl(AutomationElement parent, string controlName,
            string controlAutomationId, ControlType controlType)
        {
        ...
        /// <returns>Return the target control</returns>
        private static AutomationElement FindControl(AutomationElement parent, string controlName,
            string controlAutomationId, ControlType controlType, int timeout)
        {
            AutomationElement element = null;
        ...
        public static AutomationElement FindControlById(AutomationElement parent, string controlAutomationId,
            ControlType controlType, int timeout)
        {
        ...
        /// <param name="timeout">Time out</param>
        /// <returns>Return the target control</returns>
        public static AutomationElement FindControlByName(AutomationElement parent, string controlName,
            ControlType controlType, int timeout)
        {
        ...
        public static AutomationElement FindDialog(int processID, string dialogTitle, string dialogMessage, int timeout)
        {
            AndCondition condition =
                ...
                {
                    new PropertyCondition(AutomationElement.NameProperty, dialogMessage),
        ...
        /// <returns>Return the target window</returns>
        public static AutomationElement FindWindowControl(UIWindowAndElement action, ControlType controlType,
            int timeout)
        {
            return FindWindowControl(action.ProcessId, action.WindowName, action.ControlName, action.AutomationId,
                controlType, timeout);
        }
        ...
        private static AutomationElement FindWindowControl(int processId, string windowName, string controlName,
            string controlAutomationId, ControlType controlType, int timeout)
        {
        ...
        /// <param name="window">The out window</param>
        /// <returns>Return the target window</returns>
        public static AutomationElement FindWindowControlById(int processId, string controlAutomationId,
            ControlType controlType, int timeout)
        {
        ...
        /// <param name="timeout">The time out</param>
        /// <returns>Return the target window</returns>
        public static AutomationElement FindWindowControlById(string windowName, string controlAutomationId,
            ControlType controlType, int timeout)
        {
        ...
        /// <param name="timeout">The time out</param>
        /// <returns>Return the target control</returns>
        public static AutomationElement FindWindowControlByName(int processId, string controlName,
            ControlType controlType, int timeout)
        {
        ...
        /// <param name="timeout">The time out</param>
        /// <returns>Return the target control</returns>
        public static AutomationElement FindWindowControlByName(string windowName, string controlName,
            ControlType controlType, int timeout)
        {
        ...
        private static AutomationElement GetControl(AutomationElement parent, string controlName,
            string controlAutomationId, ControlType controlType, int timeout)
        {
            AutomationElement element = null;
            FindControlElementDelegate findControlElementDelegate =
                new FindControlElementDelegate(UIAutomationHelper.FindControl);
            IAsyncResult result = findControlElementDelegate.BeginInvoke(parent, controlName, controlAutomationId,
                controlType, null, null);
